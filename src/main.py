...
while True:
    try:
        driver.find_element('xpath', '/html/body/div[1]/div/div[1]/div/div[2]/div/div[1]/div/form/div[2]/div[1]/div/input')
        driver.find_element('xpath', '/html/body/div[1]/div/div[1]/div/div[2]/div/div[1]/div/form/div[2]/div[2]/div/input')
        driver.find_element('xpath', '/html/body/div[1]/div/div[1]/div/div[2]/div/div[1]/div/form/button')
        break
    except:
        time.sleep(1)
...
#find name="user"
user = driver.find_element('xpath', '/html/body/div[1]/div/div[1]/div/div[2]/div/div[1]/div/form/div[2]/div[1]/div/input')
passw = driver.find_element('xpath', '/html/body/div[1]/div/div[1]/div/div[2]/div/div[1]/div/form/div[2]/div[2]/div/input')
submit = driver.find_element('xpath', '/html/body/div[1]/div/div[1]/div/div[2]/div/div[1]/div/form/button')
